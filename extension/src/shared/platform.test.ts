...
describe("detectPlatform", () => {
  it("recognises the supported meeting pages", () => {
    ...
    expect(detectPlatform("https://teams.cloud.microsoft/")).toBe("teams");
    expect(detectPlatform("https://teams.cloud.microsoft/v2/?meetingjoin=true")).toBe("teams");
  ...
  it("rejects look-alike hosts, other schemes and garbage", () => {
    ...
    expect(detectPlatform("https://teams.cloud.microsoft.evil.example/")).toBeNull();
    expect(detectPlatform("https://evil.teams.cloud.microsoft/")).toBeNull();
    expect(detectPlatform("https://cloud.microsoft/")).toBeNull();
