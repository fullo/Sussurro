...
| 0.10 — Advanced meeting | #195 (system audio + mic), #196 (speaker-aware recipes/Ask), #197 (saved audio), #203 (per-speaker replay), #206 (native loopback), #207 (voice map), #212 (build-only release run), #219 (multilingual fillers) | manual QA **#184**; website **#180**; docs + release notes **#145**; security #215–#217 |
